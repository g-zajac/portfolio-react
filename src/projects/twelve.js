  ...
  return (
     <div className="project" id="smt">
      <div className="project_header">
        <h2>Twelve</h2>
        <h4>Contemporary dance performance with with remotely controlled LEDs in costumes.</h4>
        <p>Direction: Ederson Rodrigues Xavier</p>
        <p>Choreography: Ederson Rodrigues Xavier and the Transitions Dance Company</p>
