  ...
  return (
     <div className="project" id="strangers">
      <div className="project_header">
        ...
        <h4>Midi Interface for controlling Qlab. Immersive & participatory piece.</h4>
